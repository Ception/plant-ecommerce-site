...
export default function Flowers() {
  return (
    <div className='p-4'>
      <div className='flex flex-wrap -mx-3 mb-20 md:mb-40 border justify-center'>

        <div className='w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 px-3 mb-24'>
          <div className='xl:flex xl:items-center p-10 xl:py-32 mb-8 bg-white rounded-3xl'><Image src="/weedPlant.png" width={100} height={100} /></div>
