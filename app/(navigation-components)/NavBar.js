    ...
    return (
        <div className="w-48 p-4">
            <h1 className="font-bold">{accountName} #{accountIdentifier}</h1>
                ...
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40" onClick={() => setCurrentPage("Orders")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40" onClick={() => setCurrentPage("Addresses")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40" onClick={() => setCurrentPage("AccountDetails")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <hr />
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40" onClick={() => setCurrentPage("Deals")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40"onClick={() => setCurrentPage("LikedProducts")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40 transition duration-300 ease-in-out mb-2" onClick={() => setCurrentPage("ReferFriend")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <hr />
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40" onClick={() => setCurrentPage("Help")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className="flex item-center gap-1 mt-4 cursor-pointer transition duration-300 ease-in-out hover:outline-double w-40" onClick={() => setCurrentPage("Logout")}>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
